...
PeaversCommons.Events:Init(addonName, function()
	...
	C_Timer.After(0.5, function()
		...
		supportInfo:SetText(
		"Tracks and displays item levels for group members. If you enjoy this addon and would like to support its development, or if you need help, stop by the website.")
		...
		if Settings then
			...
			local settingsCategory = Settings.RegisterCanvasLayoutSubcategory(category, settingsPanel, settingsPanel
			.name)
