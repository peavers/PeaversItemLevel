...
local ADDON_NAME = "PeaversItemLevel"
local ADDON_ID = "PeaversItemLevel"
local ICON_PATH = "Interface\\AddOns\\PeaversItemLevel\\src\\Media\\Icon"

-- Initialize SupportUI namespace
local SupportUI = {}
PIL.SupportUI = SupportUI
...
function SupportUI:InitializeOptions()
    ...
    local supportCategory = Settings.RegisterCanvasLayoutSubcategory(PIL.mainCategory, panel, panel.name)
    PIL.supportCategory = supportCategory
    PIL.supportCategory.ID = panel.name
