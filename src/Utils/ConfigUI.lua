...
function ConfigUI:CreateBarOptions(content, yPos, baseSpacing, sectionSpacing)
    ...
    ilvlStepExplanation:SetText("Controls how much of the progress bar is filled based on item level differences. " ..
                               "Higher values (e.g., 5%) make the bars more sensitive to small item level differences, " ..
                               "showing greater visual distinction between players. Lower values (e.g., 1%) make the bars " ..
                               "more gradual, requiring larger item level gaps to show significant differences. " ..
                               "Example: With 2%, a player 10 item levels below the highest will show as 80% full.")
